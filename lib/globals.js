...
const _glob = {
    ...
    //Value lists
    List_mode:
        '{"manual": "manual temperature", "max": "maximum temperature", "hq": "Frost guardian temperature", "home": "home temperature" }',
    List_gateway_type:
        '{"NAPlug": "Relay / Smart vales", "NATherm1": "Smart Thermostat (NATherm1)", "NRV": "Smart Thermostat (NRV)" }',
    List_device_types: '{"thermostat": "Thermostat" }',
    List_scale:
        '{"30min": "30 Minits", "1hour": "one hour", "3hours": "Three hours", "1day": "One day", "1week": "One Week"}',
    List_type_mm:
        '{"boileron": "Boiler on", "boileroff": "Boiler off", "sum_boiler_on": "Sum of Boiler on", "sum_boiler_off": "Sum of Boiler off"}',
    List_type_rm: '{"temperature": "Temperature"}',
    List_thermmode:
        '{"away": "switchhomeschedule away from home", "hg": "switchhomeschedule frost guard", "schedule": "switchhomeschedule schedule"}',
